...
gpp_by_date_sites <- daily %>%
  group_by(site, COUNTRY, IGBP, doy) %>%
  summarize(
...
gpp_by_date_sites |>
  ...
  ggplot(aes(x = doy, y = gpp_mean)) +
  facet_wrap(vars(IGBP)) +
  geom_point(aes(color = COUNTRY)) +
  labs(x = "DOY", y = lab_gpp_daily) +
  theme_minimal() +
...
gpp_by_date_sites |>
  ...
  ggplot(aes(x = doy, y = reco_mean)) +
  facet_wrap(vars(IGBP)) +
  geom_point(aes(color = COUNTRY)) +
  labs(x = "DOY", y = lab_reco_daily) +
  theme_minimal() +
  theme(axis.title.y = element_markdown())
...
gpp_by_date_sites |>
  ...
  ggplot(aes(x = doy, y = nee_mean)) +
  facet_wrap(vars(IGBP)) +
  geom_point(aes(color = COUNTRY)) +
  labs(x = "DOY", y = lab_nee_daily) +
  theme_minimal() +
  theme(axis.title.y = element_markdown())
